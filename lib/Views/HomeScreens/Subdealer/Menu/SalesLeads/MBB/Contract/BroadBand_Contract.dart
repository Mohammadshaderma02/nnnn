...
class BroadBand_Contract extends StatefulWidget {
  var ID;
  ...
  BroadBand_Contract(
      {this.ID,this.Permessions,
        ...
        this.simCard,this.contractImageBase64,
  ...
  @override
  _BroadBand_ContractState createState() =>
      _BroadBand_ContractState(
        this.ID,
          this.Permessions,
          this.role,
...
class _BroadBand_ContractState extends State<BroadBand_Contract> {
  var submitted =false;
  ...
  _BroadBand_ContractState(
      ...
      this.deviceSerialNumber,this.deviceSerialNumberImageBase64,this.parentMSISDN,
      this.onBehalfUser, this.resellerID, this.isClaimed,
      this.salesLeadType,this.salesLeadValue, this.backPassportImageBase64,this.note, this.scheduledDate,this.email, this.countryId
      );
