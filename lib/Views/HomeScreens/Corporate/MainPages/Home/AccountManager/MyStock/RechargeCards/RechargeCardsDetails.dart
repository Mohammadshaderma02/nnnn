...
class RechargeCardsDetails extends StatefulWidget {
  //String PermessionCorporate;
  final List<dynamic> PermessionCorporate ;
  String role;
  int index;
  List Data=[];
  RechargeCardsDetails(this.PermessionCorporate, this.role,this.Data,this.index);
  @override
  _RechargeCardsDetailsState createState() => _RechargeCardsDetailsState(this.PermessionCorporate, this.role,this.Data,this.index);
}
APP_URLS urls = new APP_URLS();

class _RechargeCardsDetailsState extends State<RechargeCardsDetails> {
  ...
  _RechargeCardsDetailsState(this.PermessionCorporate, this.role,this.Data,this.index);
        ...
        child:GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text("AccountManager.RechargeCardsDetails".tr().toString(),),
              leading: IconButton(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //////////////////////////////////////////////////////
                        Text( "AccountManager.CardType".tr().toString(),),
                        SizedBox(height: 1),
                        Text(this.Data[this.index]["cardType"]!=null|| this.Data[this.index]["cardType"].length!=0?this.Data[this.index]["cardType"]:'--',
