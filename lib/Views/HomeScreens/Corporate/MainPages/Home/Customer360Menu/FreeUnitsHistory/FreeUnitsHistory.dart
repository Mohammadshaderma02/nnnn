...
class FreeUnitsHistory extends StatefulWidget {
  ...
  List data=[];
  FreeUnitsHistory(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _FreeUnitsHistoryState createState() =>
      _FreeUnitsHistoryState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _FreeUnitsHistoryState extends State<FreeUnitsHistory> {
      ...
      child: Container(
        ...
        child: TextButton(
            ...
            onPressed: () {
              ...
              GetCustomerFreeUnitsHistory_API();
            },
            child: Row(
  ...
  GetCustomerFreeUnitsHistory_API ()async{
    print('caled');
    if(fromDate.text!=''  && toDate.text!='') {
      ...
      if (fromDate.text != '' && toDate.text != '') {
        ...
        var apiArea = urls.BASE_URL +
            '/Customer360/GetCustomerFreeUnitsHistory';
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text("corpMenu.FreeUnitsHistory".tr().toString()),
            leading: IconButton(
              ...
              Container(
                ...
                Container(
                  ...
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                    itemCount: FreeUnitsHistory.length,
                    itemBuilder: (BuildContext context, int index) {
                      //   itemCount :  UserList.length,
                      return  Container(
                        decoration: BoxDecoration(
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FreeUnitsHistory.entryDate"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FreeUnitsHistory[index]['entryDate']!=null|| FreeUnitsHistory[index]['entryDate'].length==0?FreeUnitsHistory[index]['entryDate']:'-',
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FreeUnitsHistory.unitType"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FreeUnitsHistory[index]['unitType']!=null|| FreeUnitsHistory[index]['unitType'].length==0?FreeUnitsHistory[index]['unitType']:'-',
