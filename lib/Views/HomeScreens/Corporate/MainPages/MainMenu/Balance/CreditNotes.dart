...
class CreditNotes extends StatefulWidget {
  ...
  List data=[];
  CreditNotes(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _CreditNotesState createState() =>
      _CreditNotesState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
    ...
    if(fromDate.text!=''  && toDate.text!='' ) {
      ...
      if (fromDate.text != '' && toDate.text != '' ) {
        ...
        var apiArea = urls.BASE_URL +
            '/Customer360/GetCustomersCreditNotes';
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("Balance.CreditNotes".tr().toString()),
              leading: IconButton(
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            CreditNotes[index]['transactionDate']!=null|| CreditNotes[index]['transactionDate'].length==0?CreditNotes[index]['transactionDate']:'-',
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            CreditNotes[index]['amount']!=null|| CreditNotes[index]['amount'].length==0?CreditNotes[index]['amount']:'-',
