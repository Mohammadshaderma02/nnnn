...
class InvoicesList extends StatefulWidget {
  ...
  List data=[];
  InvoicesList(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _InvoicesListState createState() =>
      _InvoicesListState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
print(urls.BASE_URL + '/Customer360/getCustomerInvoicesList'+" ");
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("Balance.InvoicesList".tr().toString()),
              leading: IconButton(
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            InvoicesList[index]['date']!=null|| InvoicesList[index]['date'].length==0?InvoicesList[index]['date']:'-',
