...
class G_Contract extends StatefulWidget {
  var ID;
...
class G_ContractState extends State<G_Contract> {
  var submitted =false;
  ...
  G_ContractState(
      ...
      this.deviceSerialNumber,this.deviceSerialNumberImageBase64,this.parentMSISDN,
      this.onBehalfUser, this.resellerID, this.isClaimed,
      this.salesLeadType,this.salesLeadValue, this.backPassportImageBase64,this.note, this.scheduledDate,this.email
      );
