...
import 'package:sales_app/Views/HomeScreens/Subdealer/Menu/SalesLeads/MBB/Contract/BroadBand_Contract.dart';



class BroadBand_contractDetails extends StatefulWidget {
  var ID;
  ...
  @override
  _BroadBand_contractDetailsState createState() => _BroadBand_contractDetailsState(
    this.ID,
...
class _BroadBand_contractDetailsState extends State<BroadBand_contractDetails> {
  var ID;
  final List<dynamic> Permessions;
  var role;
  var outDoorUserName;
  ...
  final email;
  final  countryId;
  _BroadBand_contractDetailsState(
      this.ID,
      this.Permessions,
      this.role,
          ...
          Switch(
            ...
            onChanged: (value) {
              ...
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => BroadBand_Contract(ID:ID,Permessions: Permessions,role:role,outDoorUserName:outDoorUserName,FilePath: FileEPath,
