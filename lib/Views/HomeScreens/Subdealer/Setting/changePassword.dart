...
class ChangePassword extends StatefulWidget {
  ...
  var role;
  var outDoorUserName;
  ChangePassword({this.Permessions,this.role,this.outDoorUserName});


  @override
  _ChangePasswordState createState() => _ChangePasswordState(this.Permessions,this.role,this.outDoorUserName);
...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  var role;
  var outDoorUserName;
  _ChangePasswordState(this.Permessions,this.role,this.outDoorUserName);
