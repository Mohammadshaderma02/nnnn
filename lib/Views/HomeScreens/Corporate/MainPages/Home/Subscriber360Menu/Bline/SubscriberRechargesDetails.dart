...
class SubscriberRechargesDetails extends StatefulWidget {
  ...
  List data=[];
  SubscriberRechargesDetails(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _SubscriberRechargesDetailsState createState() =>
      _SubscriberRechargesDetailsState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}

APP_URLS urls = new APP_URLS();

class _SubscriberRechargesDetailsState extends State<SubscriberRechargesDetails> {
  ...
  SubscriberRechargesDetails_API ()async{
    ...
    var apiArea = urls.BASE_URL + '/Customer360/getSubscriberRecharges';
    ...
    if (statusCode == 200) {
      ...
      if( result["status"]==0){
        SubscriberRechargesDetailsData=result["data"];
        print(SubscriberRechargesDetailsData.length);
        setState(() {
          isLoading =false;
        });
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("BlineLedger.SubscriberRechargesDetails".tr().toString()),
              leading: IconButton(
              ...
              children: [
                ...
                Container(
                  ...
                  ListView.builder(
                    ...
                    physics: ClampingScrollPhysics(),
                    padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                    itemCount: SubscriberRechargesDetailsData.length,
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("BlineLedger.rechargeDate".tr().toString(),),
                                        SizedBox(height: 1),
                                        Text(
                                          SubscriberRechargesDetailsData[index]['rechargeDate']==null?'--':SubscriberRechargesDetailsData[index]['rechargeDate'].length==0?"--":SubscriberRechargesDetailsData[index]['rechargeDate'],
                                          style: TextStyle(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("BlineLedger.rechargeStatus".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          SubscriberRechargesDetailsData[index]['rechargeStatus']==null ?'--':SubscriberRechargesDetailsData[index]['rechargeStatus'].length==0?"--":SubscriberRechargesDetailsData[index]['rechargeStatus'],
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("BlineLedger.currentBalance".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          SubscriberRechargesDetailsData[index]['currentBalance']==null?'--': SubscriberRechargesDetailsData[index]['currentBalance'].length==0?"--": SubscriberRechargesDetailsData[index]['currentBalance'],
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("BlineLedger.amount".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          SubscriberRechargesDetailsData[index]['amount']==null ?'--':SubscriberRechargesDetailsData[index]['amount'].length==0?"--":SubscriberRechargesDetailsData[index]['amount'],
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("BlineLedger.rechargeType".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          SubscriberRechargesDetailsData[index]['rechargeType']==null?'--': SubscriberRechargesDetailsData[index]['rechargeType'].length==0?"--": SubscriberRechargesDetailsData[index]['rechargeType'],
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("BlineLedger.balanceType".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          SubscriberRechargesDetailsData[index]['balanceType']==null?'--':SubscriberRechargesDetailsData[index]['balanceType'].length==0?"--":SubscriberRechargesDetailsData[index]['balanceType'],
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
