...
class Invoices extends StatefulWidget {
  ...
  List data=[];
  Invoices(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _InvoicesState createState() =>
      _InvoicesState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("Balance.Invoices".tr().toString()),
              leading: IconButton(
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            Invoices[index]['date']!=null|| Invoices[index]['date'].length==0?Invoices[index]['date']:'-',
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            Invoices[index]['invoiceNumber']!=null|| Invoices[index]['invoiceNumber'].length==0?Invoices[index]['invoiceNumber']:'-',
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            Invoices[index]['amount']!=null|| Invoices[index]['amount'].length==0?Invoices[index]['amount']:'-',
