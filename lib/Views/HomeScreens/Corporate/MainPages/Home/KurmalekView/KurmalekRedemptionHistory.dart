...
class KurmalekRedemptionHistory extends StatefulWidget {
  ...
  List data=[];
  KurmalekRedemptionHistory(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _RedemptionHistoryState createState() =>
      _RedemptionHistoryState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _RedemptionHistoryState extends State<KurmalekRedemptionHistory> {
  ...
  KurmalakRedemptionHistory_API ()async{
    print('caled');
    if(fromDate.text!=''  && toDate.text!='') {
      ...
      if (fromDate.text != '' && toDate.text != '') {
        ...
        var apiArea = urls.BASE_URL +
            '/Customer360/getKurmalakRedemptionHistory';
        ...
        if (statusCode == 200) {
          ...
          if( result["status"]==0){
            if(result["data"]==null||result["data"].length==0){
              ...
              setState(() {
                KurmalakRedemptionHistory=result["data"];
                isLoading=false;
                checkData=true;
              });
            ...
            Container(
              ...
              Container(
                ...
                ListView.builder(
                  ...
                  shrinkWrap: true,
                  padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                  itemCount: KurmalakRedemptionHistory.length,
                  itemBuilder: (BuildContext context, int index) {
                    //   itemCount :  UserList.length,
                    return  Container(
                      decoration: BoxDecoration(
                                ...
                                child: Container(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['msisdn']!=null?KurmalakRedemptionHistory[index]['msisdn']:'-',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 14.0,
                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['loaded']!=null?KurmalakRedemptionHistory[index]['loaded']:'-',                                          style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                                      ),
                                ...
                                child: Container(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['type']!=null?KurmalakRedemptionHistory[index]['type']:'-',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 14.0,
                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['price']!=null?KurmalakRedemptionHistory[index]['price']:'-',                                          style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                                      ),
                                ...
                                child: Container(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['date']!=null?KurmalakRedemptionHistory[index]['date'].toString().substring(0,KurmalakRedemptionHistory[index]['date'].indexOf(' ')):'-',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 14.0,
                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['period']!=null?KurmalakRedemptionHistory[index]['period']:'-',                                          style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                                      ),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['startDate']!=null?KurmalakRedemptionHistory[index]['startDate'].toString().substring(0,KurmalakRedemptionHistory[index]['startDate'].indexOf(' ')):'-',
                                        style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                                ...
                                child: Container(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['endDate']!=null?KurmalakRedemptionHistory[index]['endDate'].toString().substring(0,KurmalakRedemptionHistory[index]['endDate'].indexOf(' ')):'-',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 14.0,
                                        ),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Kurmalek.voucherValue"
                                            .tr()
                                            .toString(),
                                      ),
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['voucherValue']!=null?KurmalakRedemptionHistory[index]['voucherValue']:'-',                                          style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                                      ),
                                ...
                                child: Container(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 1),
                                      Text(
                                        KurmalakRedemptionHistory[index]['doneBy']!=null?KurmalakRedemptionHistory[index]['doneBy'].toString().substring(0,KurmalakRedemptionHistory[index]['doneBy'].indexOf(' ')):'-',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 14.0,
                                        ),
