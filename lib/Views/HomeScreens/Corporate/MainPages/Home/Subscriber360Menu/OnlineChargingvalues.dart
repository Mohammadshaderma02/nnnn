...
class OnlineChargingValues extends StatefulWidget {
  ...
  List data=[];
  OnlineChargingValues(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _OnlineChargingValuesState createState() =>
      _OnlineChargingValuesState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _OnlineChargingValuesState extends State<OnlineChargingValues> {
  ...
  OnlineChargingValues_API ()async{
    SharedPreferences prefs = await SharedPreferences.getInstance();

    setState(() {
      isLoading=true;
    });
    var apiArea = urls.BASE_URL + '/Customer360/embeddedValues/'+this.msisdn;
    ...
    if (statusCode == 200) {
      ...
      if( result["status"]==0){
        if(result["data"]==null||result["data"].length==0){
          ...
          setState(() {
            OnlinechargingvaluesData=result["data"];
            isLoading=false;
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("OnlineChargingValuesViews.OnlineChargingvalues".tr().toString()),
              leading: IconButton(
               ...
               /* Container(
                  ...
                  Container(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                      itemCount: OnlinechargingvaluesData.length,
                      itemBuilder: (BuildContext context, int index) {
                        //   itemCount :  UserList.length,
                        return  Container(
                          decoration: BoxDecoration(
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "OnlineChargingValuesViews.service_description"
                                                .tr()
                                                .toString(),
                                          ),
                                          SizedBox(height: 1),
                                          Text(
                                            OnlinechargingvaluesData[index]['serviceDescription']!=null?OnlinechargingvaluesData[index]['serviceDescription']:'-',
                                            style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 14.0,
                                            ),
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "OnlineChargingValuesViews.value"
                                                .tr()
                                                .toString(),
                                          ),
                                          SizedBox(height: 1),
                                          Text(
                                            OnlinechargingvaluesData[index]['value']!=null?OnlinechargingvaluesData[index]['value']:'-',
                                            style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 14.0,
                                            ),
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "OnlineChargingValuesViews.end_date"
                                                .tr()
                                                .toString(),
                                          ),
                                          SizedBox(height: 1),
                                          Text(
                                            OnlinechargingvaluesData[index]['date']!=null?OnlinechargingvaluesData[index]['date'].toString():'-',                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 14.0,
                                            ),
                                          ),
