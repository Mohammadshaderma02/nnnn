...
import 'package:sales_app/Views/HomeScreens/DeliveryEShop/PostPaid/MBB/Contract/BroadBand_Contract.dart';
...
class BroadBandContractDetails extends StatefulWidget {
  ...
  BroadBandContractDetails(
      {   this.PermessionDeliveryEShop,
        this.role,
        this.orderID,
        this.packageName, this.FileEPath,
        ...
        this.salesLeadType,this.salesLeadValue,this.backPassportImageBase64,this.note,this.scheduledDate,this.documentExpiryDate
      }
      );
  ...
  _BroadBandContractDetailsState createState() => _BroadBandContractDetailsState(
      ...
      this.deviceSerialNumber,this.deviceSerialNumberImageBase64,this.parentMSISDN,
      this.onBehalfUser,this.resellerID, this.isClaimed ,
      this.salesLeadType,this.salesLeadValue,
      this.backPassportImageBase64,this.note,
    this.scheduledDate,
