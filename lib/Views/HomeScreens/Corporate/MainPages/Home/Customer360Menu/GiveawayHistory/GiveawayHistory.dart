...
class GiveawayHistory extends StatefulWidget {
  ...
  List data=[];
GiveawayHistory(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _GiveawayHistoryState createState() =>
      _GiveawayHistoryState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _GiveawayHistoryState extends State<GiveawayHistory> {
    ...
    if(fromDate.text!=''  && toDate.text!='') {
      ...
      if (fromDate.text != '' && toDate.text != '') {
        ...
        var apiArea = urls.BASE_URL +
            '/Customer360/getCustomerGiveawayHistory';
        ...
        if (statusCode == 200) {
          ...
          if( result["status"]==0){
            if(result["data"]==null||result["data"].length==0){
              ...
              setState(() {
                GiveawayHistoryData=result["data"];
                isLoading=false;
                checkData=true;
                emptyfromDate=false;
                emptytoDate=false;
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text("corpMenu.GiveAwayHistory​".tr().toString()),
            leading: IconButton(
              ...
              Container(
                ...
                Container(
                  ...
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                    itemCount: GiveawayHistoryData.length,
                    itemBuilder: (BuildContext context, int index) {
                      //   itemCount :  UserList.length,
                      return  Container(
                        decoration: BoxDecoration(
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "GiveawayHistory.giveAwayType"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          GiveawayHistoryData[index]['giveAwayType']!=null|| GiveawayHistoryData[index]['giveAwayType'].length==0?GiveawayHistoryData[index]['giveAwayType']:'-',
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "GiveawayHistory.quantity"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          GiveawayHistoryData[index]['quantity']!=null|| GiveawayHistoryData[index]['quantity'].length==0?GiveawayHistoryData[index]['quantity']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "GiveawayHistory.giveawayItem"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          GiveawayHistoryData[index]['giveawayItem']!=null|| GiveawayHistoryData[index]['giveawayItem'].length==0?GiveawayHistoryData[index]['giveawayItem']:'-',
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "GiveawayHistory.deliveryMethod"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          GiveawayHistoryData[index]['deliveryMethod']!=null|| GiveawayHistoryData[index]['deliveryMethod'].length==0?GiveawayHistoryData[index]['deliveryMethod']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "GiveawayHistory.customerName"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          GiveawayHistoryData[index]['customerName']!=null|| GiveawayHistoryData[index]['customerName'].length==0?GiveawayHistoryData[index]['customerName']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "GiveawayHistory.userName"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          GiveawayHistoryData[index]['userName']!=null|| GiveawayHistoryData[index]['userName'].length==0?GiveawayHistoryData[index]['userName']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "GiveawayHistory.receiverName"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          GiveawayHistoryData[index]['receiverName']!=null|| GiveawayHistoryData[index]['receiverName'].length==0?GiveawayHistoryData[index]['receiverName']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "GiveawayHistory.giveAwayDate"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          GiveawayHistoryData[index]['giveAwayDate']!=null|| GiveawayHistoryData[index]['giveAwayDate'].length==0?GiveawayHistoryData[index]['giveAwayDate']:'-',
