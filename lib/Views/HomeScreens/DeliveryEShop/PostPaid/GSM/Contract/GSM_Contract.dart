...
import 'package:sales_app/Views/HomeScreens/DeliveryEShop/PostPaid/GSM/Contract/Recontracting.dart';
...
class GSM_Contract extends StatefulWidget {
  ...
  _GSM_ContractState createState() =>
      _GSM_ContractState(
          ...
          this.extraExtender,
          this.simCard,
          this.contractImageBase64,this.note,
          this.militaryID,
          this.scheduledDate,
          this.isClaimed,
          this.onBehalfUser,
      ...
      content:SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              EasyLocalization.of(context).locale == Locale("en", "US")
                  ? "Do you want recontracting now ?"
                  : "هل تريد إعادة التعاقد الآن؟",
              style: TextStyle(
                color: Colors.black,
                fontSize: 16,
              ),
