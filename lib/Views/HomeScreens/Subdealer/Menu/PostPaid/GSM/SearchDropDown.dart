          ...
          children: [
            Container(
              ...
              child: TextButton(
                ...
                child: Padding(
                  padding: widget.padding??   EasyLocalization.of(context).locale == Locale("en", "US")?
                  EdgeInsets.only(left:5.0,right: 0):
                  EdgeInsets.only(left:0.0,right: 5) ,
                  child: Row(
                    children: [
                      ...
                      "Personal_Info_Edit.select_an_option".tr().toString():widget.label:onSelectLabel,
                        textAlign: widget.labelAlign??TextAlign.start,
                        style:  widget.labelStyle!=null?  widget.labelStyle.copyWith(
                          color: onSelectLabel==''?  Color(0xffa4b0c1): Color(0xffa4b0c1),
                        ):TextStyle(
                          fontWeight: FontWeight.normal,
                          fontSize: 15,
                          color: onSelectLabel==''?  Color(0xffa4b0c1): Color(0xff11120e),
                        ),)),
                      Visibility(
                       ...
                       widget.suffixIcon?? Icon(Icons.keyboard_arrow_down,
                        color: widget.primaryColor?? Color(0xffa4b0c1),
                       size: 30,)
                    ],
                  ),
                ),
