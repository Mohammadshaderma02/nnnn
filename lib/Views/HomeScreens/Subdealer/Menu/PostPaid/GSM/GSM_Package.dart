...
import 'package:sales_app/Views/HomeScreens/Subdealer/Menu/PostPaid/GSM/GSM_NationalityBasedArmy.dart';
...
class GSMPackage extends StatefulWidget {
  final List<dynamic> Permessions;
  String marketType;
  var role;
  var outDoorUserName;
  String packageCode;
  GSMPackage({this.Permessions,this.marketType,this.role,this.outDoorUserName});
  @override
  _GSMPackageState createState() => _GSMPackageState(this.Permessions,this.marketType,this.role,this.outDoorUserName);
}

class _GSMPackageState extends State<GSMPackage> {

  final List<dynamic> Permessions;
  final String marketType;
  var role;
  var outDoorUserName;
  _GSMPackageState(this.Permessions,this.marketType,this.role,this.outDoorUserName);
                                          ...
                                          SizedBox(
                                            ...
                                            child: ListTile(
                                                ...
                                                TextButton(
                                                  ...
                                                  onPressed: () {
                                                    state.data[index]['isArmy']==true?
                                                    Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => GSM_NationalityBasedArmy(
