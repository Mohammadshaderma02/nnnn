...
class Contract extends StatefulWidget {
  ...
  Contract(
      {this.Permessions,
        ...
        this.simCard,this.contractImageBase64,this.note,this.militaryID ,
        this.scheduledDate,this.isClaimed,this.onBehalfUser,this.resellerID,
