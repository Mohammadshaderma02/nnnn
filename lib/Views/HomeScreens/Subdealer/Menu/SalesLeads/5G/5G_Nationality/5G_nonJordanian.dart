...
import 'package:sales_app/Views/HomeScreens/Subdealer/Menu/SalesLeads/5G/5G_Contract/5G_ContractDetails.dart';
...
class G_nonJordanian extends StatefulWidget {
  ...
  @override
  G_nonJordanianState createState() => G_nonJordanianState(
      this.Permessions,
      this.role,
      this.outDoorUserName,
...
class G_nonJordanianState extends State<G_nonJordanian> {
...
///////////////////////////End New///////////////////////////////////////////
  ...
  void initState() {
    ...
    /* This part is new and created on 6 March 2025 to mack the sim card is esim or not with switch button
    if(isEsim==true){
      setState(() {
        isEsim=true;
        simCard.text="ESIM";
    ...
    Widget save = TextButton(
      ...
      onPressed: () {
        ...
        postpaidGenerateContractBloc.add(PostpaidGenerateContractButtonPressed(
            ...
            extraExtender: null,
            //6 March 2025 simCard: simCard.text,
...
/*...................................................New 6/3/2025.............................................................*/
  ...
  _ScanSimCard() async {
    await FlutterBarcodeScanner.scanBarcode(
        "#ff6666", "Cancel", true, ScanMode.BARCODE)
        .then((value) => setState(() => _dataSimCard = value));
    setState(() {
        ...
        listener: (context, state) async {
          ...
          if (state is PostpaidGenerateContractSuccessState) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => G_contractDetails(
                    ID:ticketID,
              ...
              body:status == '401'
                ...
                child: Column(
                  children: [
                    ...
                    /*.......................................6 March 2025 simCardNewOption Information...................................*/
                    SizedBox(height: 10),
                    buildEmail(),
                    SizedBox(height: 10),
                    Container(
