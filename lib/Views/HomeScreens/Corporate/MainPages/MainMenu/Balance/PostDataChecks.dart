...
class PostDataChecks extends StatefulWidget {
  ...
  List data=[];
  PostDataChecks(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _PostDataChecksState createState() =>
      _PostDataChecksState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _PostDataChecksState extends State<PostDataChecks> {
    ...
    if(fromDate.text!=''  && toDate.text!='' ) {
      ...
      if (fromDate.text != '' && toDate.text != '' ) {
        ...
        var apiArea = urls.BASE_URL +
            '/Customer360/getCustomersPostDatedChecks';
        ...
        if (statusCode == 200) {
          ...
          if( result["status"]==0){
            if(result["data"]==null||result["data"].length==0){
              ...
              setState(() {
                PostDataChecks=result["data"];
                print(PostDataChecks.length);
                isLoading=false;
                checkData=true;
                emptyfromDate=false;
                emptytoDate=false;
            ...
            print("getCustomersPostDatedChecks");
          }else{
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("Balance.PostDatedChecks".tr().toString()),
              leading: IconButton(
                ...
                Container(
                  ...
                  Container(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                      itemCount: PostDataChecks.length,
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            PostDataChecks[index]['checkAmount']!=null|| PostDataChecks[index]['checkAmount'].length==0?PostDataChecks[index]['checkAmount']:'-',
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            PostDataChecks[index]['bankName']!=null|| PostDataChecks[index]['bankName'].length==0?PostDataChecks[index]['bankName']:'-',
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            PostDataChecks[index]['dueDate']!=null|| PostDataChecks[index]['dueDate'].length==0?PostDataChecks[index]['dueDate']:'-',
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 1),
                                          Text(
                                            PostDataChecks[index]['entryDate']!=null|| PostDataChecks[index]['entryDate'].length==0?PostDataChecks[index]['entryDate']:'-',
