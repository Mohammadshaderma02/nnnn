...
class KurmalekPointsDetails extends StatefulWidget {
  ...
  List data=[];
  KurmalekPointsDetails(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _KurmalekPointsDetailsState createState() =>
      _KurmalekPointsDetailsState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _KurmalekPointsDetailsState extends State<KurmalekPointsDetails> {
    ...
    if(fromDate.text!=''  && toDate.text!='') {
      ...
      if (fromDate.text != '' && toDate.text != '') {
        ...
        var apiArea = urls.BASE_URL +
            '/Customer360/getKurmalakPointsDetails';
        ...
        if (statusCode == 200) {
          ...
          if( result["status"]==0){
            ...
            if(result["data"]==null||result["data"].length==0){
              ...
              setState(() {
                kurmalakPointsDetails=result["data"]["kurmalakPointsDetails"];
                gainedPoints=result["data"]["gainedPoints"];
                lostPoints=result["data"]["lostPoints"];
              ...
              Container(
                ...
                Container(
                  ...
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                    itemCount: kurmalakPointsDetails.length,
                    itemBuilder: (BuildContext context, int index) {
                      //   itemCount :  UserList.length,
                      return  Container(
                        decoration: BoxDecoration(
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 1),
                                        Text(
                                          kurmalakPointsDetails[index]['msisdn']!=null?kurmalakPointsDetails[index]['msisdn']:'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Kurmalek.invoiceNumber"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          kurmalakPointsDetails[index]['invoiceNumber']!=null?kurmalakPointsDetails[index]['invoiceNumber']:'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("Kurmalek.calculationDate".tr().toString(),

                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          kurmalakPointsDetails[index]['calculationDate']!=null?kurmalakPointsDetails[index]['calculationDate'].toString().substring(0,9):'-',                                          style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 14.0,
                                        ),
                                        ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 1),
                                        Text(
                                          kurmalakPointsDetails[index]['points']!=null?kurmalakPointsDetails[index]['points']:'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Kurmalek.lifeTimePoints"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          kurmalakPointsDetails[index]['lifeTimePoints']!=null?kurmalakPointsDetails[index]['lifeTimePoints']:'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
