...
class AdjustmentLogs extends StatefulWidget {
  ...
  List data=[];
  AdjustmentLogs(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _AdjustmentLogsState createState() =>
      _AdjustmentLogsState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _AdjustmentLogsState extends State<AdjustmentLogs> {
  ...
  AdjustmentLogs_API ()async{
    ...
    if(fromDate.text!=''  && toDate.text!='') {
      ...
      if (fromDate.text != '' && toDate.text != '') {
        ...
        String formattedTime = "23:59:00";
        var formatedDate = to.toIso8601String().split(new RegExp(r"[T\.]"));
        print(formatedDate[0]);
        var ToWithDate= "${formatedDate[0]} ${formattedTime}";
        DateTime dTO = DateTime.parse(ToWithDate);
        print(dTO);
        print(dTO.toIso8601String());
        ...
        if (statusCode == 200) {
          ...
          if( result["status"]==0){
            if(result["data"]==null||result["data"].length==0){
              ...
              setState(() {
                AdjustmentLogsData=result["data"];
                isLoading=false;
                checkData=true;
              });
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text("adjustmentLogsViews.AdjustmentLOG".tr().toString()),
            leading: IconButton(
            ...
            children: [
              Container(
                ...
                checkData==true?
                    ...
                    shrinkWrap: true,
                    physics: ClampingScrollPhysics(),
                    itemCount: AdjustmentLogsData.length,
                    itemBuilder: (BuildContext context, int index) {
                     return Container(
                       decoration: BoxDecoration(
                               ...
                               child: Container(
                                 child: Column(
                                   ...
                                   children: [
                                     ...
                                     Text(
                                       "adjustmentLogsViews.transaction_type"
                                           .tr()
                                           .toString(),
                                     ),
                                     SizedBox(height: 1),
                                     Text(
                                       AdjustmentLogsData[index]['tranasctionDescription']!=null?AdjustmentLogsData[index]['tranasctionDescription']:'-',
                                       style: TextStyle(
                                         fontWeight: FontWeight.bold,
                                         fontSize: 14.0,
                                       ),
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.user_name"
                                          .tr()
                                          .toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['adjustmentUsername']!=null?AdjustmentLogsData[index]['adjustmentUsername']:'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.Customer_Number".tr().toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['customerId']!=null?AdjustmentLogsData[index]['customerId']:'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.entry_date"
                                          .tr()
                                          .toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['transactionDate']!=null?AdjustmentLogsData[index]['transactionDate'].toString():'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.start_date"
                                          .tr()
                                          .toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['effectiveDate']!=null?AdjustmentLogsData[index]['effectiveDate'].toString():'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.shop"
                                          .tr()
                                          .toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['adjustmentShopName']!=null?AdjustmentLogsData[index]['adjustmentShopName']:'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.status"
                                          .tr()
                                          .toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['statusDescription']!=null?AdjustmentLogsData[index]['statusDescription']:'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                               ...
                               child: Container(
                                 ...
                                 child: Column(
                                   ...
                                   children: [
                                     ...
                                     Text(
                                       "adjustmentLogsViews.old_value"
                                           .tr()
                                           .toString(),
                                     ),
                                     SizedBox(height: 1),
                                     Text(
                                       AdjustmentLogsData[index]['oldValue']!=null?AdjustmentLogsData[index]['oldValue']:'-',
                                       style: TextStyle(
                                         fontWeight: FontWeight.bold,
                                         fontSize: 14.0,
                                       ),
                               ...
                               child: Container(
                                 child: Column(
                                   ...
                                   children: [
                                     ...
                                     Text(
                                       "adjustmentLogsViews.new_value"
                                           .tr()
                                           .toString(),
                                     ),
                                     SizedBox(height: 1),
                                     Text(
                                       AdjustmentLogsData[index]['newValue']!=null?AdjustmentLogsData[index]['newValue']:'-',
                                       style: TextStyle(
                                         fontWeight: FontWeight.bold,
                                         fontSize: 14.0,
                                       ),
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.billing_code"
                                          .tr()
                                          .toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['billingCode']!=null?AdjustmentLogsData[index]['billingCode']:'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.voided_by"
                                          .tr()
                                          .toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['voidedBy']!=null?AdjustmentLogsData[index]['voidedBy']:'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "adjustmentLogsViews.bill_code_description"
                                          .tr()
                                          .toString(),
                                    ),
                                    SizedBox(height: 1),
                                    Text(
                                      AdjustmentLogsData[index]['billCodeDescription']!=null?AdjustmentLogsData[index]['billCodeDescription']:'-',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14.0,
                                      ),
