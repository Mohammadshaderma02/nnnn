...
class SubsidyPromotion extends StatefulWidget {
  ...
  List data=[];
  SubsidyPromotion(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _SubsidyPromotionState createState() =>
      _SubsidyPromotionState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}

APP_URLS urls = new APP_URLS();

class _SubsidyPromotionState extends State<SubsidyPromotion> {
  ...
  var CustomerSerialsPoolingHistoryData=[];
  ...
  SerialsPoolingHistory_API ()async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    Map test = {
    ...
    var apiArea = urls.BASE_URL + '/Customer360/getCustomerSerialsPoolingHistory';
    ...
    if (statusCode == 200) {
      ...
      if( result["status"]==0){
        if(result["data"]==null||result["data"].length==0){
          ...
          CustomerSerialsPoolingHistoryData=result["data"];

          print(CustomerSerialsPoolingHistoryData.length);
          setState(() {
            isLoading =false;
          });
        }
      ...
      print('-------------------------------');
      print('Sucses API');
      print(urls.BASE_URL +'/Customer360/getCustomerSerialsPoolingHistory');
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("MainPromotions.SubsidyPromotion".tr().toString()),
              leading: IconButton(
              ...
              children: [
                ...
                Container(
                  ...
                  ListView.builder(
                    ...
                    physics: ClampingScrollPhysics(),
                    padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                    itemCount: CustomerSerialsPoolingHistoryData.length,
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("MainPromotions.serialNumber".tr().toString(),),
                                        SizedBox(height: 1),
                                        Text(
                                          CustomerSerialsPoolingHistoryData[index]['serialNumber']??'-',
                                          style: TextStyle(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("MainPromotions.startDate".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          CustomerSerialsPoolingHistoryData[index]['startDate'].toString().substring(0,10) ??'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("MainPromotions.userName".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          CustomerSerialsPoolingHistoryData[index]['userName']??'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("MainPromotions.shopName".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          CustomerSerialsPoolingHistoryData[index]['shopName']??'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("MainPromotions.paidAmount".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          CustomerSerialsPoolingHistoryData[index]['paidAmount'].toString()??'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("MainPromotions.deviceType".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          CustomerSerialsPoolingHistoryData[index]['deviceType']??'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
