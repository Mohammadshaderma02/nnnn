...
class LineActiveSubsidy extends StatefulWidget {
  ...
  List data=[];
  LineActiveSubsidy(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _LineActiveSubsidyState createState() =>
      _LineActiveSubsidyState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}

APP_URLS urls = new APP_URLS();

class _LineActiveSubsidyState extends State<LineActiveSubsidy> {
  ...
  LineActiveSubsidy_API ()async{
    ...
    var apiArea = urls.BASE_URL + '/Customer360/getCustomerLinesWithActiveSubsidy';
    ...
    if (statusCode == 200) {
      ...
      if( result["status"]==0){
        if(result["data"]==null||result["data"].length==0){
          ...
          LineActiveSubsidyData=result["data"];
          print(LineActiveSubsidyData.length);
          setState(() {
            isLoading =false;
          });
        }
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("MainPromotions.LinewithActiveSubsidy".tr().toString()),
              leading: IconButton(
              ...
              children: [
                ...
                Container(
                  ...
                  ListView.builder(
                    ...
                    physics: ClampingScrollPhysics(),
                    padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                    itemCount: LineActiveSubsidyData.length,
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 1),
                                        Text(
                                          LineActiveSubsidyData[index]['msisdn'].toString().substring(0,10)??'-',
                                          style: TextStyle(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("MainPromotions.stampedSerialNumber".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          LineActiveSubsidyData[index]['stampedSerialNumber'] ??'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 1),
                                        Text(
                                          LineActiveSubsidyData[index]['deviceType']??'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("MainPromotions.terminationFees".tr().toString(),),

                                        SizedBox(height: 1),
                                        Text(
                                          LineActiveSubsidyData[index]['terminationFees']??'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
