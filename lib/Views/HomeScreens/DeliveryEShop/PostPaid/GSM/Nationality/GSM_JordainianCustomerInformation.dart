...
class GSM_JordainianCustomerInformation extends StatefulWidget {
  ...
  GSM_JordainianCustomerInformation(
  ...
  @override
  _GSM_JordainianCustomerInformationState createState() =>
      _GSM_JordainianCustomerInformationState(
          this.Permessions,
          this.role,
          this.orderID,
          this.packageName,
...
class _GSM_JordainianCustomerInformationState
    extends State<GSM_JordainianCustomerInformation> {
...
/*...........................................Receipt attachment.................................................*/
  ...
  bool _loadIdReceipt = false;
  File imageFileReceiptt = File('');
...
/*..............................................................................................................*/
  ...
  TextEditingController _paymentMethodName = TextEditingController();
  ...
  /*..........................................................................................*/
  TextEditingController reContractor = TextEditingController();
...
/*...........................................Document Expiry Date.........................................*/
  ...
  /*  if(isEsim==true){
    ...
    setState(() {
      ...
      _paymentMethodName.text=paymentMethodName;
      ...
      onPressed: () {
        ...
        postpaidGenerateContractBloc.add(PostpaidGenerateContractButtonPressed(
          isRental: false,
            ...
            extraExtender: null,
            simCard: isEsim == true ? "ESIM" : simCard.text,
            contractImageBase64: img64Contract,
            isClaimed: false,
            note: GETcommitment.text,
            militaryID: null,
            scheduledDate: null,
            onBehalfUser:  "" ,
            resellerID: "",
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.all(16),
              hintText: "Postpaid.enter_first_name".toString(),
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.all(16),
              hintText: "Postpaid.enter_second_name".toString(),
              hintStyle: TextStyle(color: Color(0xFFA4B0C1), fontSize: 14),
            ),
          ),
        ),
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.all(16),
              hintText: "Postpaid.enter_third_name".toString(),
              hintStyle: TextStyle(color: Color(0xFFA4B0C1), fontSize: 14),
            ),
          ),
        ),
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.all(16),
              hintText: "Postpaid.enter_last_name".toString(),
              hintStyle: TextStyle(color: Color(0xFFA4B0C1), fontSize: 14),
            ),
          ),
        ),
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.all(16),
              hintText: "Postpaid.enter_reference_number".toString(),
              hintStyle: TextStyle(color: Color(0xFFA4B0C1), fontSize: 14),
            ),
          ),
        ),
                          ...
                          child: Align(
                              ...
                              child: EasyLocalization.of(context)
                                ...
                                children: [
                                 ...
                                 /* Text(
                                    "Jordan_Nationality.take_photo2".toString(),
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: Color(0xFF0070c9),
                                      fontSize: 16,
  ...
  void pickImageReceiptCamera() async {
    ...
    if (pickedFileReceipt != null) {
      ...
      calculateImageSize(pickedFileReceipt.path);
  ...
  void pickImageReceiptGallery() async {
    pickedFileReceipt = await _picker.pickImage(
      source: ImageSource.gallery,
    );
    ...
    if (cropped != null) {
      ...
      this.setState(() {
        if (mb > 2) {
          ...
          imageFileReceiptt = File(cropped.path);
  ...
  void retrieve_updated_price_API() async {
    ...
    Map test = {
      ...
      "IsJordanian": true,
      "NationalNo": null,
      "PassportNo": this.nationalNumber,
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
            ...
            body: ListView(padding: EdgeInsets.only(top: 8), children: <Widget>[
              ...
              /*..........................................................................................................*/
              /*.....The Receipt & Auth code & Last 4 digits will appear if PaymentMethodSystemName=card on delivery.....*/
              /*.........................................................................................................*/
              /*...........................................Receipt attachment............................................*/
              ...
              Container(
                  ...
                  child: TextButton(
                    onPressed: isDisabled
                      ...
                      if(PaymentMethodSystemName=="Payments.CardOnDelivery" && isEsim==true){
                        if (img64Front != null &&
                            img64Back != null &&
                      ...
                      if(PaymentMethodSystemName=="Payments.CardOnDelivery" && isEsim==false){
                        if (img64Front != null &&
                            img64Back != null &&
                            referenceNumber.text != '' &&
                            documentExpiryDate.text !="" &&
