...
class BroadBandContract extends StatefulWidget {
  ...
  @override
  _BroadBandContractState createState() =>
      _BroadBandContractState(
          this.PermessionDeliveryEShop,
          this.role,
          this.orderID,
          this.packageName,
...
class _BroadBandContractState extends State<BroadBandContract> {
  var PermessionDeliveryEShop = [];
  var orderID = '';
  var packageName = '';
  var submitted =false;
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: btnDisabled==true?Color(0xFF392156).withOpacity(0.6)  :Color(0xFF392156),
                      ),
                      child: TextButton(

                        onPressed: () async {
                          print('signatureImageBase64 ${signatureImageBase64}');
