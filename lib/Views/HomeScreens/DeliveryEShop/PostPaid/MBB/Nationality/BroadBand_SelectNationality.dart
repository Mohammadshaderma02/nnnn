...
import 'package:sales_app/Views/HomeScreens/DeliveryEShop/PostPaid/MBB/Nationality/BroadBand_Jordanina.dart';
import 'package:sales_app/Views/HomeScreens/DeliveryEShop/PostPaid/MBB/Nationality/BroadBand_NonJordanina.dart';
...
class _BroadBandNationalityListState extends State<BroadBandNationalityList> {
  ...
  showAlertDialogSucssesJordanian(BuildContext context, arabicMessage,
      englishMessage, msisdn, Username, Password, Price) {
    AlertDialog alert = AlertDialog(
        ...
        TextButton(
          onPressed: ()async {
            ...
            await Navigator.of(context)
                .push(new MaterialPageRoute(builder: (context) => BroadBandNonJordainian(
                this.PermessionDeliveryEShop,
                this.role,
                this.orderID,
                this.packageName,
