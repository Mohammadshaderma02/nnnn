...
class Promotions extends StatefulWidget {
  ...
  Promotions(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _PromotionsState createState() =>
      _PromotionsState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _PromotionsState extends State<Promotions> {
  ...
  String HandsetType;
  String ActiveSubsidy;
  String PricePaid;
  String ShopName;
  String TerminationFees;
    ...
    if (statusCode == 200) {
      ...
      if( result["status"]==0){
        setState(() {
          ...
          CommitmentPeriod=result["data"]['commitmentPeriod'];
          PromotionStartDate=result["data"]['promotionStartDate'];
          PromotionEndDate=result["data"]['promotionEndDate'];
          NameofEmployee=result["data"]['username'];
          HandsetSerial=result["data"]['handsetSerial'];
          HandsetType=result["data"]['handsetType'];
          //ActiveSubsidy=result["data"][""];
          PricePaid=result["data"]['pricePaid'];
          ShopName=result["data"]['shopName'];
          TerminationFees=result["data"]['terminationFees'];
          DisconnectionPeriod=result["data"]['disconnectionPeriod'];
      ...
      print('-------------------------------');
      print('Sucses API');
      print(urls.BASE_URL +'/Customer360/subscriberSubsidyDetails');
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("PromotionsView.Promotions".tr().toString()),
              leading: IconButton(
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "PromotionsView.ShopName".tr().toString(),
                                ),
                                SizedBox(height: 1),
                                Text(
                                  ShopName==null?"--":  ShopName.length==0?"-":ShopName,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                Text(
                                  "PromotionsView.NameOfEmployee".tr().toString(),
                                ),
                                SizedBox(height: 1),
                                Text(
                                  NameofEmployee==null?"--": NameofEmployee.length==0?"-":NameofEmployee,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                Text(
                                  "PromotionsView.PromotionStartDate".tr().toString(),
                                ),
                                SizedBox(height: 1),
                                Text(
                                  PromotionStartDate==null?"--":  PromotionStartDate.length==0?"-":PromotionStartDate,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                Text(
                                  "PromotionsView.PromotionEndDate".tr().toString(),
                                ),
                                SizedBox(height: 1),
                                Text(
                                  PromotionEndDate==null?"--": PromotionEndDate.length==0?"-":PromotionEndDate,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                Text("PromotionsView.CommitmentPeriod".tr().toString(),),
                                SizedBox(height: 1),
                                Text(
                                  CommitmentPeriod==null?"--": CommitmentPeriod.length==0?"-":CommitmentPeriod,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                Text("PromotionsView.HandsetSerial".tr().toString(),),
                                SizedBox(height: 1),
                                Text(
                                  HandsetSerial==null?"--": HandsetSerial.length==0?"-":HandsetSerial,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                Text("PromotionsView.HandsetType".tr().toString(),),
                                SizedBox(height: 1),
                                Text(
                                  HandsetType==null?"--":  HandsetType.length==0?"-":HandsetType,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                /*   SizedBox(height: 20),
                  Text("PromotionsView.ActiveSubsidy".tr().toString(),),
                  SizedBox(height: 1),
                  Text(
                    '-'+ActiveSubsidy,
                    style: TextStyle(
                      ...
                      fontSize: 14.0,
                                ...
                                SizedBox(height: 20),
                                Text("PromotionsView.PricePaid".tr().toString(),),
                                SizedBox(height: 1),
                                Text(
                                  PricePaid==null?"--": PricePaid.length==0?"-":PricePaid,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                SizedBox(height: 20),
                                Text("PromotionsView.TerminationFees".tr().toString(),),
                                SizedBox(height: 1),
                                Text(
                                  TerminationFees==null?"--": TerminationFees.length==0?"-":TerminationFees,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
                                ...
                                SizedBox(height: 20),
                                Text("PromotionsView.DisconnectionPeriod".tr().toString(),),
                                SizedBox(height: 1),
                                Text(
                                  DisconnectionPeriod==null?"--":  DisconnectionPeriod.length==0?"-":DisconnectionPeriod,
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14.0,
                                  ),
