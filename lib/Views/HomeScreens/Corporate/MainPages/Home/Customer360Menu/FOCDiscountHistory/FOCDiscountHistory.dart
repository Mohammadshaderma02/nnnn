...
class FOCDiscountHistory extends StatefulWidget {
  ...
  List data=[];
  FOCDiscountHistory(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _FOCDiscountHistoryState createState() =>
      _FOCDiscountHistoryState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _FOCDiscountHistoryState extends State<FOCDiscountHistory> {
      ...
      child: Container(
        ...
        child: TextButton(
            ...
            onPressed: () {
              ...
              getCustomerFOCDiscountHistory_API();
              setState(() {
                FOCDiscountHistoryData=[];
              });
            },
            child: Row(
  ...
  getCustomerFOCDiscountHistory_API ()async{
    print('caled');
    if(fromDate.text!=''&& toDate.text!='') {
      ...
      if (fromDate.text != '' && toDate.text != '') {
        ...
        var apiArea = urls.BASE_URL +
            '/Customer360/getCustomerFOCDiscountHistory';
        ...
        if (statusCode == 200) {
          ...
          if( result["status"]==0){
            if(result["data"]==null||result["data"].length==0){
              ...
              setState(() {
                FOCDiscountHistoryData=result["data"];
                isLoading=false;
                checkData=true;
                emptyfromDate=false;
                emptytoDate=false;
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text("corpMenu.FOCDiscountHistory".tr().toString()),
            leading: IconButton(
              ...
              Container(
                ...
                Container(
                  ...
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    padding: EdgeInsets.only(top: 8, left: 0, right: 0),
                    itemCount: FOCDiscountHistoryData.length,
                    itemBuilder: (BuildContext context, int index) {
                      //   itemCount :  UserList.length,
                      return  Container(
                        decoration: BoxDecoration(
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.serial"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['serial']!=null|| FOCDiscountHistoryData[index]['serial'].length==0?FOCDiscountHistoryData[index]['serial']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.Date"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['focDate']!=null|| FOCDiscountHistoryData[index]['focDate'].length==0?FOCDiscountHistoryData[index]['focDate']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.originalPrice"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['originalPrice']!=null|| FOCDiscountHistoryData[index]['originalPrice'].length==0?FOCDiscountHistoryData[index]['originalPrice']:'-',
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.focDiscountAmount"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['focDiscountAmount']!=null|| FOCDiscountHistoryData[index]['focDiscountAmount'].length==0?FOCDiscountHistoryData[index]['focDiscountAmount']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.paidAmount"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['paidAmount']!=null|| FOCDiscountHistoryData[index]['paidAmount'].length==0?FOCDiscountHistoryData[index]['paidAmount']:'-',
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.presentedByID"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['presentedByID']!=null|| FOCDiscountHistoryData[index]['presentedByID'].length==0?FOCDiscountHistoryData[index]['presentedByID']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.presentedByName"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['presentedByName']!=null|| FOCDiscountHistoryData[index]['presentedByName'].length==0?FOCDiscountHistoryData[index]['presentedByName']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.presentedTo"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['presentedTo']!=null|| FOCDiscountHistoryData[index]['presentedTo'].length==0?FOCDiscountHistoryData[index]['presentedTo']:'-',
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "FOCDiscountHistory.receivedBy"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          FOCDiscountHistoryData[index]['receivedBy']!=null|| FOCDiscountHistoryData[index]['receivedBy'].length==0?FOCDiscountHistoryData[index]['receivedBy']:'-',
