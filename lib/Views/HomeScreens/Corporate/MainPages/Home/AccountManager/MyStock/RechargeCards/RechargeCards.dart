...
class RechargeCards extends StatefulWidget {
  //String PermessionCorporate;
  final List<dynamic> PermessionCorporate ;
  String role;
  RechargeCards(this.PermessionCorporate, this.role);
  @override
  _RechargeCardsState createState() => _RechargeCardsState(this.PermessionCorporate, this.role);
}
APP_URLS urls = new APP_URLS();

class _RechargeCardsState extends State<RechargeCards> {
  ...
  _RechargeCardsState(this.PermessionCorporate, this.role);
  ...
  MenaTracks_API ()async{
    ...
    var apiArea = urls.BASE_URL+'/Customer360/getVouchersStockPerUser';
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 1),
                                            Text(
                                              MenaTracks[index]['cardType']!=null|| MenaTracks[index]['cardType'].length!=0?MenaTracks[index]['cardType']:'--',
                                          ...
                                          IconButton(
                                            ...
                                            onPressed: () async{
                                              ...
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) => RechargeCardsDetails(PermessionCorporate, role,MenaTracks,index),
                                                ),
                                              );
                                            },
                                          ),
