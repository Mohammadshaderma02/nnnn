...
class BlineLedger extends StatefulWidget {
  ...
  List data=[];
  BlineLedger(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _BlineLedgerState createState() =>
      _BlineLedgerState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _BlineLedgerState extends State<BlineLedger> {
  ...
  Unbilled_API ()async{
    ...
    if (statusCode == 200) {
      ...
      if( result["status"]==0){
        setState(() {
          blineCreditBalance=result["data"]['blineCreditBalance'];
          dataBalance=result["data"]['dataBalance'];
          customerUnbillidAirTime=result["data"]['customerUnbillidAirTime'];
          subscriberUnbillidAirTime=result["data"]['subscriberUnbillidAirTime'];
          unbillidCustomerHSPATopupView=result["data"]['unbillidCustomerHSPATopupView'];
          unbilledSubscriberHSPATopUpView=result["data"]['unbilledSubscriberHSPATopUpView'];
          unbilledFeaturesAmount=result["data"]['unbilledFeaturesAmount'];
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text( "UnbilledView.DataWallet".tr().toString(),),
                            SizedBox(height: 1),
                            Text(
                              dataBalance.length==0?"-":dataBalance,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0,
                              ),
                            ...
                            Text("UnbilledView.BlineCreditBalance".tr().toString(),),
                            SizedBox(height: 1),
                            Text(
                              blineCreditBalance.length==0?"-":blineCreditBalance,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0,
                              ),
                            ...
                            Text(
                              subscriberUnbillidAirTime.length==0?"-":subscriberUnbillidAirTime,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0,
                              ),
                            ...
                            SizedBox(height: 1),
                            Text(
                              unbilledSubscriberHSPATopUpView.length==0?"-":unbilledSubscriberHSPATopUpView,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0,
                              ),
                            ...
                            Text(
                              "UnbilledView.UnbilledFeaturesAmount".tr().toString(),
                            ),
                            SizedBox(height: 1),
                            Text(
                              unbilledFeaturesAmount.length==0?"-":unbilledFeaturesAmount,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0,
                              ),
                              ...
                              ListTile(
                                  ...
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => SubscriberRechargesDetails(PermessionCorporate, role,searchID,searchValue,customerNumber,msisdn,data,searchCraretia),
                                      ),
                      ...
                      SizedBox(
                        ...
                        child:  Card(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ListTile(
                                  title: Text("BlineLedger.SubscriberMoneyTransferRequests".tr().toString(),
                                      style: TextStyle(color: Colors.white)),
                                  trailing: IconButton(
                                    icon: EasyLocalization.of(context).locale ==
                                        Locale("en", "US")
                                  ...
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => SubscriberMoneyTransferRequest(PermessionCorporate, role,searchID,searchValue,customerNumber,msisdn,data,searchCraretia),
                                      ),
