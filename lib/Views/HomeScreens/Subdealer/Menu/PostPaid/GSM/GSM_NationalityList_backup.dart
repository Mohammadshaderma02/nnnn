    ...
    return BlocListener<PostValidateSubscriberBlock, PostValidateSubscriberState>(
      listener: (context, state) {
        ...
        if (state is PostValidateSubscriberSuccessState) {
          ...
          // ✅ If called from Next button (after document scan), navigate directly
          if (_isCallingFromNextButton) {
            setState(() {
              _isCallingFromNextButton = false; // Reset flag
            });
            print("✅ API success from Next button - Navigating to Jordanian customer information");
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => JordainianCustomerInformation(
            ...
            // Called from Check button - show dialog as before
        ...
        children: <Widget>[
          ...
          if (_documentProcessingSuccess && (globalVars.tackTemporary || globalVars.tackForeign)) ...[
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  // Navigate to non-Jordanian customer information screen
                  print("✅ Navigating to non-Jordanian customer information screen");
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NonJordainianCustomerInformation(
