...
class PresetRisk extends StatefulWidget {
  ...
  List data=[];
  PresetRisk(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _PresetRiskState createState() =>
      _PresetRiskState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _PresetRiskState extends State<PresetRisk> {
  ...
  String presetRiskPerSub;
  String presetRiskLastUpdate;
  String tempPresetRisk;
  String localLimitValue;
  String localUsedValue;
  String internationalUsedValue;
  String internationallimitValue;
  ...
  PresetRisk_API ()async{
    ...
    if (statusCode == 200) {
      ...
      if( result["status"]==0){
        setState(() {
          presetRiskPerSub=result["data"]['presetRiskSubscriberDetails']['presetRiskPerSub'];
          presetRiskLastUpdate=result["data"]['presetRiskSubscriberDetails']['presetRiskLastUpdate'];
          tempPresetRisk=result["data"]['presetRiskSubscriberDetails']['tempPresetRisk'];
          localLimitValue=result["data"]['localPresetLimitDetails']['limitValue'];
          localUsedValue=result["data"]['localPresetLimitDetails']['usedValue'];
          internationallimitValue=result["data"]['internationalPresetLimitDetails']['limitValue'];
          internationalUsedValue=result["data"]['internationalPresetLimitDetails']['usedValue'];
          isLoading =false;
        });
      }else{
      ...
      print('-------------------------------');
      print('Sucses API');
      print(urls.BASE_URL +'/Customer360/presetRiskDetails');
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("SubscriberView.PresetRisk".tr().toString()),
              leading: IconButton(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "PresetRiskViews.RiskPerSubscriber".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                        presetRiskPerSub==null?"--":  presetRiskPerSub.length==0?'--':presetRiskPerSub,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0,
                        ),
                      ...
                      Text(
                        "PresetRiskViews.RiskLastUpdate".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                        presetRiskLastUpdate==null?"--":  presetRiskLastUpdate.length==0?'--':presetRiskLastUpdate,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0,
                        ),
                      ...
                      Text(
                        "PresetRiskViews.TempRisk".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                        tempPresetRisk==null?"--":   tempPresetRisk.length==0?'--':tempPresetRisk,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0,
                        ),
                      ...
                      Text(
                        "PresetRiskViews.LocalLimitValue".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                        localLimitValue==null?"--": localLimitValue.length==0?'--':localLimitValue,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0,
                        ),
                      ...
                      Text(
                        "PresetRiskViews.LocalUsedValue".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                        localUsedValue==null?"--": localUsedValue.length==0?'--':localUsedValue,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0,
                        ),
                      ...
                      Text(
                        "PresetRiskViews.InternationalLimitValue".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                        internationallimitValue==null?"--":  internationallimitValue.length==0?'--':internationallimitValue,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0,
                        ),
                    ...
                    SizedBox(
                      ...
                      Text(
                        "PresetRiskViews.InternationalUsedValue".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                        internationalUsedValue==null?"--":  internationalUsedValue.length==0?'--':internationalUsedValue,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0,
                        ),
