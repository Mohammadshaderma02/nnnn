...
class BillShock extends StatefulWidget {
  ...
  BillShock(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _BillShockState createState() =>
      _BillShockState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _BillShockState extends State<BillShock> {
  ...
  showAlertDialogSucsse(BuildContext context, arabicMessage, englishMessage) {
          ...
          onPressed: () {
            ...
            setState(() {
              ...
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => BillShock(PermessionCorporate,role,searchID,searchValue,customerNumber,msisdn,this.data,this.searchCraretia),
                ),
              );
  ...
  billShock_API ()async{
    ...
    var apiArea = urls.BASE_URL + '/Customer360/BillShock/profile/'+this.msisdn;
    ...
    if (statusCode == 200) {
      ...
      print("GET"+urls.BASE_URL +'/Customer360/BillShock/profile/'+this.msisdn);
      return result;
    }else{
    ...
    if (statusCode == 200) {
      ...
      if( result["status"]==0){
       ...
       if(result["message"]=="The Operation has been Successfully Completed"){
         showAlertDialogSucsse(context,result["messageAr"], result["message"]);
       }
      ...
      print('Sucses API');
      print("POST"+urls.BASE_URL +'/Customer360/BillShock/profile/'+this.msisdn);
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("billShockView.BillShock".tr().toString()),
              leading: IconButton(
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "billShockView.status"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          BillShockData['status']!=null?BillShockData['status']:'-',
                                          style: TextStyle(
                                            color:BillShockData['status']!="Connected"? Colors.red:Colors.green,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                        ),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "billShockView.serviceType"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          BillShockData['serviceType']!=null?BillShockData['serviceType']:'Not Received',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "billShockView.usedAmount"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          BillShockData['usedAmount']!=null?BillShockData['usedAmount']:'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "billShockView.remainingAmount"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          BillShockData['remainingAmount']!=null?BillShockData['remainingAmount']:'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "billShockView.limitValue"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          BillShockData['limitValue']!=null?BillShockData['limitValue']:'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "billShockView.language"
                                              .tr()
                                              .toString(),
                                        ),
                                        SizedBox(height: 1),
                                        Text(
                                          BillShockData['language']!=null?BillShockData['language']:'-',
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 14.0,
                                          ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              BillShockData['status']!="Connected"  && BillShockData['status']!=null ?  buildReconnectBtn():Container(),
                            ]),)
