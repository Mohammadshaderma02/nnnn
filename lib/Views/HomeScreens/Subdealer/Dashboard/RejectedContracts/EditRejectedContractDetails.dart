...
class EditRejectedContractDetails extends StatefulWidget {
  Map data = new Map();
  var Permessions=[];
  var role;
  var outDoorUserName;
  EditRejectedContractDetails({this.data,this.Permessions,this.role,this.outDoorUserName});


  @override
  _EditRejectedContractDetailsState createState() =>
      _EditRejectedContractDetailsState(this.data,this.Permessions,this.role,this.outDoorUserName);
}

class _EditRejectedContractDetailsState
    extends State<EditRejectedContractDetails> {
  Map data = new Map();
  var Permessions=[];
  var role;
  var outDoorUserName;
  ...
  ReservedLineBloc reservedLineBloc;
  ...
  /*KitCode() async {
    ...
    prefs.setString("kitcodetest", data['kitCode'].toString());
    print("hhhhhhhhhhhhhhhhaaaaaaa");
    print(prefs);
  }*/
  ...
  void initState() {
    ...
    reservedLineBloc = BlocProvider.of<ReservedLineBloc>(context);
    unReservedLineBloc = BlocProvider.of<UnReservedLineBloc>(context); //New
    //reservedLineBloc.add(PressReservedLineEvent(kitCode:data['kitCode'].toString())); //New Line
    ...
    Widget tryAgainButton = TextButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => PendingContracts(),
          ),
        );
      },
    );
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => RejectedContracts(Permessions:Permessions,role:role,outDoorUserName:outDoorUserName),
              ),
            );
          },
        ),
        centerTitle:false,
        title: Text("DashBoard_Form.Edit_contract_details".tr().toString()),
                  ...
                  SizedBox(
                    ...
                    child: ListTile(
                      leading: Container(
                        width: 160,
                        child: Text(
                          "DashBoard_Form.reject_date".tr().toString(),
                          style: TextStyle(
                              fontSize: 14,
                              color: Color(0xff11120e),
                              fontWeight: FontWeight.normal),
                  ...
                  SizedBox(
                    ...
                    child: ListTile(
                      leading: Container(
                        width: 160,
                        child: Text(
                          "DashBoard_Form.reject_reason".tr().toString(),
                          style: TextStyle(
                              fontSize: 14,
                              color: Color(0xff11120e),
                              fontWeight: FontWeight.normal),
                    ...
                    onPressed: () async {
                      ...
                      if (imageFileID != null && imageFileContract != null) {
                        reservedLineBloc.add(PressReservedLineEvent(
                            kitCode: data['kitCode'].toString())); //New Line
