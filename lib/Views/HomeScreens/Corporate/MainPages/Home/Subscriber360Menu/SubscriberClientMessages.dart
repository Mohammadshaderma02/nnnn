...
class SubscriberClientMessages extends StatefulWidget {
  ...
  SubscriberClientMessages(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _SubscriberClientMessagesState createState() =>
      _SubscriberClientMessagesState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}

APP_URLS urls = new APP_URLS();

class _SubscriberClientMessagesState extends State<SubscriberClientMessages> {
  ...
  getClientMessages_API ()async{
    ...
    if (statusCode == 200) {
      ...
      print('Sucses API');
      print("Subscriber360view"+"  "+urls.BASE_URL +'/getClientMessages');
