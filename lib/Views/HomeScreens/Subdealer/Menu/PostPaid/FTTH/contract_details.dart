...
import 'package:sales_app/Views/HomeScreens/Subdealer/Menu/PostPaid/FTTH/Contract.dart';
...
final thirdName;
  ...
  _ContractDetailsState( this.Permessions,this.role,this.outDoorUserName,  this.FileEPath,
      ...
      this.salesLeadType,this.salesLeadValue,this.onBehalfUser,
      this.resellerID,
      this.isClaimed,
      this.backPassportImageBase64,
      this.note,
