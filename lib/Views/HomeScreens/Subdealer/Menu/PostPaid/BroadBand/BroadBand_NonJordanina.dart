...
class BroadBandNonJordainian extends StatefulWidget {
  ...
  @override
  _BroadBandNonJordainianState createState() => _BroadBandNonJordainianState(
      this.role,
      this.outDoorUserName,
      this.Permessions,
      this.msisdn,
...
class _BroadBandNonJordainianState extends State<BroadBandNonJordainian> {
...
/*........................................................................................................*/
  ...
  void initState() {
    ...
    print("/**********************device5GType************************");
    print(this.device5GType);
    print("/**********************Packages_5G************************");
    print(this.Packages_5G);
    print("/**********************The Role************************");
    print(this.role);
    print("/**********************isRental************************");
    print(isRental);

    print("isParentEligible NonJordanin");
            ...
            child: DropdownButtonHideUnderline(
              child: ButtonTheme(
                ...
                child: DropdownButton<String>(
                  ...
                  value: selectedBEHALF_key,
                  onChanged: (String newValue) {
                    //Navigator.pop(context);

                    setState(() {
                      selectedBEHALF_key = newValue;
                    });
    ...
    Widget save = TextButton(
      ...
      onPressed: () {
        ...
        postpaidGenerateContractBloc.add(PostpaidGenerateContractButtonPressed(
           ...
           //2025 backPassportImageBase64:img64PassportBack,
            backPassportImageBase64:this.Packages_5G==true?null:img64PassportBack,
                ...
                MaterialPageRoute(
                  builder: (context) => BroadBand_RentalContract(
                     ...
                     // isMigrate: this.Packages_5G==true? isParentEligible:false,
                      ...
                      extraFreeMonths: null,
                      extraExtender: null,
                      // simCard: sendOtp == true ? simCard.text : null, msisdn
                      simCard: simCard.text,
                      contractImageBase64: null,
                      deviceSerialNumber: SerialNumber.text,
                      deviceSerialNumberImageBase64: img64SerialDevice,
                    ...
                    children: <Widget>[
                      Container(
                       ...
                       //     this.Packages_5G==true?  buildCommitmentlist():Container(),
                            ...
                            ////////////////New 22/3/2022////////////////////////////////////////
                            Permessions.contains('05.02.01.04') == true && on_BEHALF == true?
                            Container(
                              color: Colors.white,
                              padding: EdgeInsets.only(
                            ...
                            Permessions.contains("05.02.02.04")==true && role=="ZainTelesales"?Container(
                                color: Colors.white,
                                padding: EdgeInsets.only(left: 5, right: 5, bottom: 8),
                            ...
                            //////////////// end New////////////////////////////////////////
                            ////////////////New 22/3/2022////////////////////////////////////////
                            Permessions.contains('05.02.01.04') == true?  Container(
                                color: Colors.white,
                                padding: EdgeInsets.only(left: 5, right: 5, bottom: 8,top: 10),
                                child: buildON_BEHALF()):Container(),
                            ////////////////////////////end new////////////////////////////////////
                            ////////////////New 17/4/2022////////////////////////////////////////
                            role=="ZainTelesales"&&  Permessions.contains('05.02.01.05') == true?  Container(
                                color: Colors.white,
                                padding: EdgeInsets.only(left: 5, right: 5, bottom: 8,top: 10),
                                child: buildON_Reseller()):Container(),

                            role=="ZainTelesales" &&  Permessions.contains('05.02.01.06') == true?  Container(
                                color: Colors.white,
                                padding: EdgeInsets.only(left: 5, right: 5, bottom: 8,top: 10),
...
width: 500,
             ...
             Container(
               ...
               this.Packages_5G==true?Container():    Container(child: buildImagePassportBack()),
                /******************************************Sim Card Part****************************************************/
              ...
              // disabel on 5 Feb 2025 this.device5GType=="Outdoor" || this.device5GType=="Indoor"?
             ...
             /*   Permessions.contains('05.02.01.01') == true
                    ? Container(
                        height: 60,
                        padding: EdgeInsets.only(top: 8),
                        child: ListTile(
             ...
             //   Permessions.contains('05.02.01.01') == true && (this.device5GType=="Outdoor" || this.device5GType=="Indoor")?
                ...
                Container(
                    ...
                    child: TextButton(
                      onPressed: isDisabled
                                ...
                                if (isParentEligible == true) {
                                  ...
                                  if (isParentEligibleShow.text != '') {
                                    ...
                                    if (isParentEligibleShow.text.length != 10 ||
                                        isParentEligibleShow.text.substring(0, 3) !=
                                            '079') {
                                      setState(() {
                                        errorParentEligibleShow = true;
                                      });
                       ...
                       /*disable on 5 Feb 2025 if(  this.device5GType!="Outdoor" || this.device5GType!="Indoor"){
                        ...
                        if(Permessions.contains('05.02.01.09')==true){
                          if (Permessions.contains('05.02.03.01') == true && role!="ZainTelesales") {
                            if(Packages_5G==false){
                              ...
                              if(Packages_5G==false){
                                ...
                                if (isParentEligible == false) {
                                  if (img64Passport != null &&
                                      ...
                                      day.text != '' &&
                                      month.text != '' &&
                                      year.text != '' &&selectedBEHALF_key !=null &&selectedReseller_key !=null && selectedCounrty_key != null)  {
                                    if (int.parse(day.text) >= 1 &&
                                        int.parse(day.text) <= 31) {
                                      errorDay = false;
                                    } else {
                              ...
                              if(Packages_5G==true){
                                ...
                                if (isParentEligible == true ) {
                                  if (img64Passport != null &&
                                      ...
                                      year.text != ''&&
                                      selectedBEHALF_key !=null
                                      &&selectedReseller_key !=null && selectedCounrty_key != null) {
                            ...
                            if(Packages_5G==true){
                              ...
                              if (isParentEligible == true ) {
                                ...
                                /*   Disable on 5 Feb 2025
                                         if( this.device5GType!="Outdoor" || this.device5GType!="Indoor"){
                                    if (img64Passport != null &&
                                        referenceNumber.text != '' &&
                                        documentExpiryDate.text != ''&&
                                        clearSucssesFlag == 1&&
