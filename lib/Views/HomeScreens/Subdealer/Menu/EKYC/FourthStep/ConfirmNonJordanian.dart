...
class ConfirmNonJordanian extends StatefulWidget {
  final Function onStepChanged;
  ConfirmNonJordanian({ this.onStepChanged});

  @override
  State<ConfirmNonJordanian> createState() => _ConfirmNonJordanianState();
}

class _ConfirmNonJordanianState extends State<ConfirmNonJordanian> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child:  Padding(
                        ...
                        child: Center(
                          child:Text(
                            EasyLocalization.of(context).locale == Locale("en", "US")? "Please check and confirm your passport scan information": "يرجى التحقق من معلومات مسح جواز السفر الخاصة بك",
                  ...
                  Center(
                    child: Container(
                      ...
                      padding: EdgeInsets.symmetric(horizontal: 20,vertical: 10),// Set height as per your requirement
                        ...
                        children: [
                          Row(
                            children: [
                              Flexible(
                                child: Text(
                                  EasyLocalization.of(context).locale == Locale("en", "US")? "Full Name": "الاسم الكامل",
                          ...
                          Row(
                              ...
                              children:[
                                Expanded(
                                  flex:1,
                                  child: Text(
                                    EasyLocalization.of(context).locale == Locale("en", "US")?  "Passport Number": "رقم جواز السفر",
                                    style: TextStyle(fontSize: 12,
                                        color: Color(0xFF5E5E5E),
                                        fontWeight: FontWeight.normal),
                                    softWrap: true,
                                ...
                                Expanded(
                                  flex: 1,
                                  child: Text(
                                    EasyLocalization.of(context).locale == Locale("en", "US")? "Personal number": "الرقم الشخصي",
                                    style: TextStyle(fontSize: 12,
                                        color: Color(0xFF5E5E5E),
                                        fontWeight: FontWeight.normal),
                                    softWrap: true,
                          ...
                          Image(
                            width: 250,
                            height: 250,
                            image: AssetImage('lib/Views/HomeScreens/Subdealer/Menu/EKYC/images/PassportFrame.png'),
