...
class Unbilled extends StatefulWidget {
  ...
  List data=[];
// Unbilled(this.PermessionCorporate, this.role,this.customerNumber,this.msisdn);
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("UnbilledView.Unbilled".tr().toString()),
              leading: IconButton(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "UnbilledView.Unbilled".tr().toString(),
                            ),
                            SizedBox(height: 1),

                            Text(
                              subscriberUnbillidAirTime==null?"--": subscriberUnbillidAirTime.length==0?"-":subscriberUnbillidAirTime,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0,
                              ),
                            ...
                            Text(
                              "UnbilledView.UnbilledHSPATopup".tr().toString(),
                            ),
                            SizedBox(height: 1),
                            Text(
                              unbilledSubscriberHSPATopUpView==null?"--":  unbilledSubscriberHSPATopUpView.length==0?"-":unbilledSubscriberHSPATopUpView,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0,
                              ),
                            ...
                            SizedBox(height: 1),
                            Text(
                              unbilledFeaturesAmount==null?"--":  unbilledFeaturesAmount.length==0?"-":unbilledFeaturesAmount,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0,
                              ),
