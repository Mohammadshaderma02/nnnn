...
import 'package:sales_app/Views/HomeScreens/Subdealer/Menu/PostPaid/GSM/GSM_NationalityList.dart';
...
class PRETOPOSTPackages extends StatefulWidget {
  ...
  PRETOPOSTPackages({ this.Permessions,this.marketType,this.role,this.outDoorUserName,
  this.msisdn,this.nationalNumber,this.userName,this.password,this.packageCode,this.sendOtp,this.showSimCard,this.price,this.isArmy,this.showCommitmentList});
  @override
  _PRETOPOSTPackagesState createState() => _PRETOPOSTPackagesState(    this.Permessions,this.marketType,this.role,this.outDoorUserName,
      this.msisdn,this.nationalNumber,this.userName,this.password,this.packageCode,this.sendOtp,this.showSimCard,this.price,this.isArmy,this.showCommitmentList);
}

class _PRETOPOSTPackagesState extends State<PRETOPOSTPackages> {
  ...
  var isArmy;
  var showCommitmentList;
  _PRETOPOSTPackagesState(
      this.Permessions,this.marketType,this.role,this.outDoorUserName,
      this.msisdn,this.nationalNumber,this.userName,this.password,this.packageCode,this.sendOtp,this.showSimCard,this.price,this.isArmy,this.showCommitmentList);
...
/////////////////////////////////////////////////////////////
  void initState() {
    ...
    postpaidEligiblePackagesBlock.add(PostpaidEligiblePackagesSelect(marketType:"GSM"));
  ...
  void callApi () async{
    ...
    }, body: jsonEncode({"marketType": widget.marketType,}),);
                                                    ...
                                                    Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                        builder: (context) => JordainianCustomerInformation(
                                                            ...
                                                            msisdn: marketType=="GSM"?msisdn:msisdn, nationalNumber:nationalNumber,passportNumber:null,
                                                            userName:userName,password:password,marketType:marketType,packageCode:state.data[index]['packageCode'],
                                                            sendOtp:sendOtp,
                                                            showSimCard:showSimCard,
                                                            price:price,
                                                            isArmy:state.data[index]['isArmy'],
