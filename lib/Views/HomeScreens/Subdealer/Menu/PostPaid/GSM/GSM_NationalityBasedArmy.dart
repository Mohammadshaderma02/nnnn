...
class GSM_NationalityBasedArmy extends StatefulWidget {
  var isARMY;
  var role;
  var   outDoorUserName;
  String marketType;
  ...
  GSM_NationalityBasedArmy({this.Permessions,this.role,this.outDoorUserName,this.marketType,this.packageCode,this.isARMY});

  @override
  _GSM_NationalityBasedArmyState createState() =>
      _GSM_NationalityBasedArmyState(this.Permessions,this.role,this.outDoorUserName,this.marketType,this.packageCode,this.isARMY);
}

class _GSM_NationalityBasedArmyState extends State<GSM_NationalityBasedArmy> {
  var isARMY;
  final List<dynamic> Permessions;
  String marketType;
  String packageCode;
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child:CustomSearchableDropDown(
                ...
                dropDownMenuItems: hazaimeh?.map((item) {
                  return item;
                })?.toList() ??
                    [],
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          appBar: AppBar(
            ...
            centerTitle:false,
            title: Text(
              "Select_Nationality.select_nationality".tr().toString()+'new',
            ),
            backgroundColor: Color(0xFF4f2565),
          ),
