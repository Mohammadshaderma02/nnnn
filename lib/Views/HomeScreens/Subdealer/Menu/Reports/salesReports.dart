...
class SalesReports extends StatefulWidget {
  ...
  var role;
  var outDoorUserName;
  SalesReports({this.Permessions,this.role,this.outDoorUserName});
  @override
  _SalesReports createState() => _SalesReports(this.Permessions,this.role,this.outDoorUserName);
}

class _SalesReports extends State<SalesReports> {

  List<dynamic>Permessions;
  var role;
  var outDoorUserName;
  _SalesReports(this.Permessions,this.role,this.outDoorUserName);
  ...
  void callApi(int page) async {
    ...
    var url =
        urls.BASE_URL+'/Tawasol/sdlr/sales-report?FromDate=${from.year.toString().padLeft(2, '0')}-${from.month.toString().padLeft(2, '0')}-${from.day.toString()}&ToDate=${to.year.toString().padLeft(2, '0')}-${to.month.toString().padLeft(2, '0')}-${to.day.toString()}&Limit=5&Page=${page}';
    ...
    if (statusCode == 200) {
      ...
      if (result['status'] == 0) {
        ...
        setState(() {
         ...
         showAlertDialog(context, result["messageAr"], result["message"]);
          ...
          children: [
            ...
            Flexible(
              child: Container(
                ...
                height: 50,
                child: IconButton(
                    icon:Icon (Icons.calendar_month, color:  Color(0xffa4b0c1), size: 30,),
                    onPressed: () async {
                      showDatePicker(
                        context: context,
                        initialDate: DateTime.now(),
                        ...
                        child: Column(children: [
                          ...
                          Container(
                              ...
                              'contractDate'] !=
                                  null
                                  ? Text(
                                "Reports.ContractDate"
                                    .tr()
                                    .toString() +
                                    " " +
                                    '${UserList[index]['contractDate']}',
                                style: TextStyle(
                                    fontSize: 16,
                                    color: Color(
                                        0xff11120e),
                          ...
                          Container(
                              ...
                              'totalCommission'] !=
                                ...
                                "Reports.Commission"
                                    ...
                                    .toString() +
                                    " " +
                                    '${UserList[index]['totalCommission']}',
                                style: TextStyle(
                                    fontSize: 16,
                                    color: Color(
                                        0xff11120e),
