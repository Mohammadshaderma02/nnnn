...
import 'CustomerEligibleLines.dart';
import 'LineActiveSubsidy.dart';




class MainPromotions extends StatefulWidget {
  ...
  List data=[];
  MainPromotions(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _MainPromotionsState createState() =>
      _MainPromotionsState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _MainPromotionsState extends State<MainPromotions> {
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text("corpMenu.Promotions".tr().toString(),),
            leading: IconButton(
                            ...
                            ListTile(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => CustomerEligibleLines(PermessionCorporate, role,searchID,searchValue,customerNumber,msisdn,data,searchCraretia),
                                    ),
                    ...
                    SizedBox(
                      ...
                      child:  Card(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ListTile(
                                title: Text("MainPromotions.SubscriberwithActiveSubsidy".tr().toString(),
                                    style: TextStyle(color: Colors.white)),
                                trailing: IconButton(
                                  icon: EasyLocalization.of(context).locale ==
                                      Locale("en", "US")
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LineActiveSubsidy(PermessionCorporate, role,searchID,searchValue,customerNumber,msisdn,data,searchCraretia),
                                    ),
                            ...
                            ListTile(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => TransferHistory(PermessionCorporate, role,searchID,searchValue,customerNumber,msisdn,data,searchCraretia),
                                    ),
                            ...
                            ListTile(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => SubsidyPromotion(PermessionCorporate, role,searchID,searchValue,customerNumber,msisdn,data,searchCraretia),
                                    ),
