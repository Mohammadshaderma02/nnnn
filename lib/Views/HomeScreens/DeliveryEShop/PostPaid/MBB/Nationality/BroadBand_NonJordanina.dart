...
/*.......................................8/4/2023...........................................*/
    ...
    print('hello');
    print(
        '${PermessionDeliveryEShop} ${passportNumber} ${msisdn} ${userName} ${password} ${marketType} ${packageCode}');
  }
                          ...
                          Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                ////////////////New 22/3/2022////////////////////////////////////////
                                PermessionDeliveryEShop.contains('12.02.02.02') == true && on_BEHALF == true?
                                Container(
                                  color: Colors.white,
                                  padding: EdgeInsets.only(
                                ...
                                PermessionDeliveryEShop.contains('12.02.02.01') == true && reseller == true?
                                Container(
                                  color: Colors.white,
                                  padding: EdgeInsets.only(
                                      left:0, right:0, top: 12, bottom: 10),
                                ...
                                PermessionDeliveryEShop.contains("12.02.02.04")==true ?Container(
                                    color: Colors.white,
                                ...
                                //////////////// end New////////////////////////////////////////
                                ////////////////New 22/3/2022////////////////////////////////////////
                                PermessionDeliveryEShop.contains('12.02.02.02') == true?  Container(
                                    color: Colors.white,
                                    padding: EdgeInsets.only(left: 5, right: 5, bottom: 8,top: 10),
                                    child: buildON_BEHALF()):Container(),
                                ////////////////////////////end new////////////////////////////////////
                                ////////////////New 17/4/2022////////////////////////////////////////
                                PermessionDeliveryEShop.contains('05.02.01.05') == true?  Container(
                                    color: Colors.white,
                                    padding: EdgeInsets.only(left: 5, right: 5, bottom: 8,top: 10),
                    ...
                    Container(
                        ...
                        child: TextButton(
                          ...
                          setState(() {
                            ...
                            if (PermessionDeliveryEShop.contains('05.02.03.01') == true) {
                           ...
                           /* if(img64SerialDevice==null){
                            ...
                            if (PermessionDeliveryEShop.contains('05.02.03.01') == true && role!="DeliveryEShop") {
                              if (isParentEligible == true &&
                                  isParentEligibleShow.text == '') {
                                setState(() {
                                  emptyParentEligibleShow = true;
                              ...
                              if(on_BEHALF==true && reseller==true){
                                ...
                                if (isParentEligible == true &&
                                  ...
                                  if (img64Passport != null &&
                                      ...
                                      day.text != '' &&
                                      month.text != '' &&
                                      year.text != ''&&selectedBEHALF_key !=null &&selectedReseller_key !=null) {
