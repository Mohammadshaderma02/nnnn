...
class VPNDetails extends StatefulWidget {
  ...
  VPNDetails(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
  @override
  _VPNDetailsState createState() =>
      _VPNDetailsState(this.PermessionCorporate, this.role,this.searchID,this.searchValue,this.customerNumber,this.msisdn,this.data,this.searchCraretia);
}
...
class _VPNDetailsState extends State<VPNDetails> {
  ...
  vpnDetails_API ()async{
    ...
    var apiArea = urls.BASE_URL + '/Customer360/vpn';
    ...
    if (statusCode == 200) {
      ...
      print('Sucses API');
      print(urls.BASE_URL +'/Customer360/vpn');
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("SubscriberView.VPNDetails".tr().toString()),
              leading: IconButton(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "SubscriberView.ShortCode".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                        shortCode.length==0?'-':shortCode,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0,
                        ),
                      ...
                      Text(
                        "SubscriberView.VPNStatus".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                      ...
                      Text(
                        "SubscriberView.NetworkID".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
                      ...
                      Text(
                        "SubscriberView.VPNLevel".tr().toString(),
                      ),
                      SizedBox(height: 1),
                      Text(
