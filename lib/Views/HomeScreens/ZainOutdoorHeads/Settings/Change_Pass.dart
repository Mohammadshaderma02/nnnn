...
class Change_Pass extends StatefulWidget {
  ...
  var role;
  var outDoorUserName;
  Change_Pass({this.PermessionZainOutdoorHeads,this.role,this.outDoorUserName});

  @override
  State<Change_Pass> createState() => _Change_PassState(this.PermessionZainOutdoorHeads,this.role,this.outDoorUserName);
}
...
class _Change_PassState extends State<Change_Pass> {
  ...
  _Change_PassState(this.PermessionZainOutdoorHeads, this.role, this.outDoorUserName);
