...
class _ContractState extends State<Contract> {
      ...
      onPressed: () async {
       ...
       /* SharedPreferences prefs = await SharedPreferences.getInstance();
        Navigator.push(
          context,
          MaterialPageRoute(
              builder:(context)=>CustomBottomNavigationBar(Permessions:Permessions,role:prefs.get('role'))
          ),
        );*/
      },
    );
  ...
  showAlertDialogSuccess(BuildContext context, arabicMessage, englishMessage,String url) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      actions: [
        close,
        Permessions.contains('05.02.02.01')? showAppointment==true?
